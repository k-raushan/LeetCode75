/**
 * Day 2: LC 1071 - Greatest Common Divisor of Strings
 * Time Complexity: O(n + m) - Based on string concatenation check and Euclidean GCD algorithm.
 * Space Complexity: O(n + m) - Resulting from string concatenation and comparison.
 */
...
class SolutionLC1071 {
	...
	public String gcdOfStrings(String str1,
		...
		if (!(str1 + str2).equals(str2 + str1)) {
			...
			int gcdLength = getGCD(str1.length(),
					str2.length());
