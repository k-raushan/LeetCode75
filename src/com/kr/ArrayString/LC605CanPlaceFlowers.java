/**
 * Day 4: LC 605 - Can Place Flowers
 * Time Complexity: O(n) - We check each plot in the flowerbed once.
 * Space Complexity: O(1) - Constant extra space used for counters.
 */
...
public class LC605CanPlaceFlowers {
	...
	public static void main(String[] args) {
		...
		System.out.println(solution
				.canPlaceFlowers(array1, 1));

		int[] array2 = { 1, 0, 0, 0, 1 };
		System.out.println(solution
				.canPlaceFlowers(array2, 2));

		int[] array3 = { 0, 0, 1, 0, 0 };
		System.out.println(solution
				.canPlaceFlowers(array3, 2));
